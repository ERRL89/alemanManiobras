<?php
    ...
    $menu = true;
    $datatables = true;
    $idTable = 'facturasPagadas';
    $pageTitle = "Facturas Pagadas Aleman Maniobras y Logistica"; 
    $titleMain = "Facturas Pagadas";
    ...
    #/////// CUERPO DE LA TABLA //////////
    $consultaStr = "SELECT * FROM facturas WHERE estatus=?";
