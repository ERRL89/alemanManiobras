                                      ...
                                      <tbody>
                                        <tr>
                                          <td style='line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;' align='left'>
                                            ...
                                            <p class='text-gray-700' style='line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;' align='left'>El dia de hoy no tienes facturas por cobrar. Revisa tu plataforma para validar que no existan facturas atrasadas por cobrar.</p>
                                            <br>
                                            <center>
                                              <a href='https://maniobrasylogistica.com/plataforma' style='color: #0d6efd;'>
                                              <button class='btn btn-primary'>Acceder a plataforma</button>
                                              </a>
