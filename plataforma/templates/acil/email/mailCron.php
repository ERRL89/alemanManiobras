                                      ...
                                      <tbody>
                                        <tr>
                                          <td style='line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;' align='left'>
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td class='col-12' style='line-height: 24px; font-size: 16px; min-height: 1px; font-weight: normal; padding-right: 24px; width: 100%; margin: 0;' align='left' valign='top'>
                                                      <center>
                                                        <img class='img-fluid' src='https://maniobrasylogistica.com/images/logo.png' style='height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; max-width: 100%; width: 100%; border-style: none; border-width: 0;' width='100%'>
                                                      </center>
                                                    </td>
                                                  </tr>
                                                </tbody>
                                            ...
                                            <p class='text-gray-700' style='line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;' align='left'>&#161;Buen d&#237;a!</p>
                                            ...
                                            <p class='text-gray-700' style='line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;' align='left'>Esperando se encuentre bien, le comparto los datos de la siguiente factura con fecha de pago para el d&#237;a de hoy.</p>
                                            <br>
                                            <ul>
                                              <li>
                                                <strong>Factura: </strong>$numFct</li>
                                              <li>
                                                <strong>Nombre: </strong>$name</li>
                                              <li>
                                                <strong>RFC: </strong>$rfc</li>
                                              <li>
                                                <strong>Monto: </strong>$$monto</li>
                                            </ul>
                                            <br>
                                            <p class='text-gray-700' style='line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;' align='left'>Ingresa a tu plataforma y valida que no existan facturas atrasadas pendientes de cobrar.</p>
                                            <br>
                                            <div>
                                              <center><a href='https://maniobrasylogistica.com/plataforma' style='color: #0d6efd;'><button>Acceder a plataforma</button></a></center>
                                            </div>
                                            <table class='s-5 w-full' role='presentation' border='0' cellpadding='0' cellspacing='0' style='width: 100%;' width='100%'>
                                              <tbody>
                                                <tr>
                                            ...
                                            <div>
                                              ...
                                              <p class='text-gray-700 text-center' style='line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;' align='center'>Soporte T&#233;cnico</p>
                                            </div>
                                          </td>
                                        </tr>
                                      </tbody>
