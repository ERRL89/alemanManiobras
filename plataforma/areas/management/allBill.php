<?php
    ...
    #VARIABLES DE PÁGINA
    $menu = true; 
    $pageTitle = "Historial de Facturas Aleman Maniobras y Logistica";
    $titleMain = "Facturas > Historial de facturas";
    $levelAccess = 6;
    
    #INICIO PÁGINA
    include $root."templates/$theme/header.php";
    include $root."templates/$theme/title.php";
    include $root."templates/$theme/areas/managment/allBillForm.php";
